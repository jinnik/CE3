...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance = 2cm, auto]
    ...
    \draw (i) -- (j);
  \end{tikzpicture}
  \caption{Schematic overview of points used in method}
  \label{fig:stencil}
\end{figure}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \begin{axis}
      ...
      \addplot3 [surf, mesh/ordering=y varies] table {stable_plot.csv};
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \begin{axis}
      ...
      \addplot3 [surf, mesh/ordering=y varies] table {unstable_plot.csv};
    \end{axis}
  \end{tikzpicture}
