...
\begin{figure}[!h]
  ...
  \begin{tikzpicture}[node distance = 2cm, auto]
    \node [circ              , label={below:$\xi_{1}=0$}] (xi1) {};
    \node [circ, right of=xi1, label={below:$\xi_{i}$} ] (xi2)   {};
    \node [circ, right of=xi2, label={below:$...$}] (xi3) {};
    \node [circ, right of=xi3  , label={below:$...$}] (xi4) {};
    \node [circ, right of=xi4  , label={below:$\xi_{n}=1$}] (xin) {};
    \node [circ, right of=xin  , label={below:$\xi_{n+1}$}] (xin+1) {};
    \draw (xi1) -- (xi2) -- (xi3) -- (xi4) -- (xin);
